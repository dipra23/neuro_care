...
Map<String, DigimonData> data = {
  "botomon":
  DigimonData(title: "Botomon", level: 0, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  "koromon":
  DigimonData(title: "Koromon", level: 1, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  "agumon":
  DigimonData(title: "Agumon", level: 2, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  "agumon_savers": DigimonData(
      title: "Agumon (Savers)",
      level: 2,
      imageUrl: "assets/Agumon(savers).jpeg"),
  "greymon":
  DigimonData(title: "Greymon", level: 3, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  "tyranomon": DigimonData(
      title: "Tyranomon", level: 3, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  "agumon_burst": DigimonData(
      title: "Agumon (Burst mode)",
      level: 3,
      imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  "metal_greymon": DigimonData(
      title: "Metal Greymon", level: 4, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  "master_tyranomon": DigimonData(
      title: "Master Greymon",
      level: 4,
      imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  // "goldromon": DigimonData(
  //     title: "Goldromon", level: 5, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  // "rize_greymon": DigimonData(
  //     title: "Rize Greymon", level: 4, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  // "shine_greymon": DigimonData(
  //     title: "Shine Greymon", level: 6, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  // "war_greymon": DigimonData(
  //     title: "War Greymon", level: 6, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
  // "skull_greymon": DigimonData(
  //     title: "Skull Greymon", level: 4, imageUrl: "assets/puzzleimages/MOUNTAIN.jpg"),
          ...
          child: Padding(
            ...
            child: DirectGraph(
              ...
              nodeBuilder: (BuildContext context, NodeInput node) => FittedBox(
                child: Image.asset("assets/puzzleimages/MOUNTAIN.jpg"),
